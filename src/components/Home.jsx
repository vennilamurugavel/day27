...
function Home() {
  ...
  return (
    <div className='container-fluid home-wrapper'>
        ...
        {
          blogs.map((e)=>{
            return <BlogCard title={e.title} image={e.image} name={e.name} username={e.username} email={e.email} phone={e.phone} website={e.website} description={e.description} key={e.id}/>
          })
        }
